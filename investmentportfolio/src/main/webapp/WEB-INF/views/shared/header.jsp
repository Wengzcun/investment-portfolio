  <nav class="navbar navbar-expand-lg navbar-dark bg-dark fixed-top" id="mainNav">
    <a class="navbar-brand" href="index.html">Investment</a>
    ...
    <div class="collapse navbar-collapse" id="navbarResponsive">
      <ul class="navbar-nav navbar-sidenav" id="exampleAccordion">
        <li class="nav-item" data-toggle="tooltip" data-placement="right" title="Dashboard">
          <a class="nav-link" href="${contextRoot}/investmentportfolio/getCustomerDetails">
       ...
       <!--  <li class="nav-item" data-toggle="tooltip" data-placement="right" title="Dashboard">
        ...
        <li class="nav-item" data-toggle="tooltip" data-placement="right" title="Dashboard">
          <a class="nav-link" href="${contextRoot}/investmentportfolio/fundscheme">
            <i class="fa fa-fw fa-dashboard"></i>
            <span class="nav-link-text">Scheme</span>
          </a>
        </li>
        ...
        <li class="nav-item" data-toggle="tooltip" data-placement="right" title="Dashboard">
          <a class="nav-link" href="${contextRoot}/investmentportfolio/fixeddeposite">
            <i class="fa fa-fw fa-dashboard"></i>
            <span class="nav-link-text">Fixed Deposit</span>
          </a>
        </li>
   <!-- <li class="nav-item" data-toggle="tooltip" data-placement="right" title="Charts">
        ...
        <li class="nav-item" data-toggle="tooltip" data-placement="right" title="Example Pages">
          ...
          <ul class="sidenav-second-level collapse" id="collapseExamplePages">
            <li>
              <a href="${contextRoot}/login">Login Page</a>
            </li>
            <li>
