	    ...
	    <ol class="breadcrumb">
	     ...
	     <div class="panel panel-default">
			    <div class="panel-body">
			    	<sf:form class="form-horizontal" modelAttribute="addFixedDeposit" action="${contextRoot}/investmentportfolio/submitfixeddeposit" method="POST">
							  ...
							  <div class="form-group">
							    ...
							    <sf:input type="number" path="amount" id="policyAmountId" class="form-control"></sf:input>
							  </div>
							  <div class="form-group">
							    <label for="Name">Policy Period:</label>
							     <sf:select path = "policyperiod" class="form-control" id="policyPeriod" onlick="selectYear(this)">
							  ...
							  <div class="form-group">
							    ...
							    <sf:select path = "bankname" class="form-control" id="policyBankName" onChange="selectBank(this)">
